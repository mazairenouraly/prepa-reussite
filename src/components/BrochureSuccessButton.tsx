...
import { TrendingUp, Download, Mail, CheckCircle, AlertCircle, X, Send, Star, Phone } from 'lucide-react';
...
export const BrochureSuccessButton = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const success = await EmailService.sendSuccessStoryRequest(formData.email, formData.name, formData.phone);
                  ...
                  <div className="p-8 text-center">
                    ...
                    <div className="bg-gradient-to-r from-green-50 to-blue-50 p-4 rounded-lg mb-4">
                      ...
                      >
                        ...
                        <span>Success Story envoyée par email</span>
                      </motion.div>
                  ...
                  <>
                    ...
                    <div className="p-4 sm:p-6">
                      ...
                      <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                          <label className="block text-sm font-medium text-prepa-blue mb-1">Nom complet *</label>
                          <input
                            type="text"
                            required
                            value={formData.name}
                        ...
                        <div>
                          <label className="block text-sm font-medium text-prepa-blue mb-1 flex items-center gap-2">
